...
export const COMMANDS: CommandGroup[] = [
  ...
  {
    name: "Other",
    items: [graphCommand, duneCommand, tallyCommand, transactionCommand],
  },
  {
    name: "NFT",
    items: [nftFloorPriceCommand, nftImageCommand, nftTotalSalesVolumeCommand],
  },
  { name: "Tokens", items: [tokenPriceCommand] },
];

export const COMMAND_ITEMS = COMMANDS.flatMap((group) => group.items);
